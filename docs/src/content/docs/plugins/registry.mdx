...
The plugin registry is the supported catalog for sandboxed plugins. Anyone can browse published plugins at [plugins.emdashcms.com](https://plugins.emdashcms.com). Administrators can review and install them from the EmDash admin panel.
