...
EmDash displays the **Registry** catalog after the sandbox runner is configured. See the [`registry` configuration reference](/reference/configuration/#registry) to select a different aggregator, set registry policy, or disable discovery.
