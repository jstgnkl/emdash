...
| Settings | Configure the site, authentication, backups, [site transfer](/guides/site-transfer/), email, search, and other services |
...
- Admins can change the content model, users, plugins, redirects, backups, and settings, can
  export or import the whole site, and can permanently delete trashed content.
