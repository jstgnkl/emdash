/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=dist/emdash_bot/wrangler.json` (hash: 0bdf79d7eae132bdeafa7200ec4a1158)
...
interface __BaseEnv_Env {
	...
	EMDASH_BOT_OPERATOR_SECRET: string;
	GITHUB_APP_PRIVATE_KEY: string;
	Sandbox: DurableObjectNamespace<import("./dist/emdash_bot/index").Sandbox>;
	DASHBOARD: DurableObjectNamespace<import("./dist/emdash_bot/index").DashboardDO>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "Sandbox" | "OrchestratorDO" | "FlueClassifyCommandAgent" | "FlueInvestigateAgent" | "GitHubRateLimitDO" | "DashboardDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_APP_ID" | "GITHUB_APP_INSTALLATION_ID" | "GITHUB_OWNER" | "GITHUB_REPO" | "PREVIEW_PACKAGE" | "GITHUB_WEBHOOK_SECRET" | "EMDASH_BOT_OPERATOR_SECRET" | "GITHUB_APP_PRIVATE_KEY">> {}
}
